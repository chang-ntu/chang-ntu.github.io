...
<div style="display: flex; align-items: center;">
    <div style="width: 70px; height: 50px; margin-right: 10px;">
        <img src="/workspaces/chang-ntu.github.io/images/NTU_Logo.png" alt="Nanyang Technological University Logo" style="width: 100%; height: 100%; object-fit: contain;" />
    </div>
    <div>
...
<div style="display: flex; align-items: center;">
    <div style="width: 70px; height: 50px; margin-right: 10px;">
        <img src="/workspaces/chang-ntu.github.io/images/UESTC_Logo.png" alt="UESTC Logo" style="width: 100%; height: 100%; object-fit: contain;" />
    </div>
    <div>
